...
// Helper function to get environment variables (works with both Bun and Node.js)
...
/**
 * Get Baltic region cables with all their segments
 * Baltic region: 53°N to 66°N, 10°E to 30°E
 */
export async function getBalticCablesWithSegments() {
  const db = getDb();
